...
export async function PUT(
  ...
  try {
    ...
    if (body.costo_mo_detalle !== undefined) {
      updateFields.costo_mo_detalle = body.costo_mo_detalle;
    }
    ...
    if (body.boleta_creada !== undefined) {
      updateFields.boleta_creada = body.boleta_creada;
    }
    if (body.costo_total_override !== undefined) {
      updateFields.costo_total_override = body.costo_total_override;
    }
    ...
    if (body.costo_repuestos_override !== undefined) {
      updateFields.costo_repuestos_override = body.costo_repuestos_override;
    }
